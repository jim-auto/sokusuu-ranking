...
- 収集: `monthly_collect.py --mode monthly --year 2026 --month 7 --global-search --prefetch-only`
- **本表は月間5即以上のみ（4即以下は掲載しない）**
- **根拠ツイートは月間即数の総括であることを人手精査**（累計・序数・通算・bioのみ・部分集計は除外）
- 収集後修正:
  - `@cx_lm5`: 抽出58→**5**（本文の「合計58即」は年累計、7月は5即）
  - `@bookmaker_2015`: 抽出9→**12**（弾丸9+即2+準1）
  - `@anshin_pua`: 抽出2→**10**（同ツイ内「7月10即」）
- チャネル: 総括本文キーワード優先（ストナン/ネトナン/箱/その他/謎）
- 根拠は **URLリンクのみ**
- `@kent_o_o` 7月: 総括本文にチャネル語なし → **謎**（bio「路上」override は月次確定に使わない）
- 取りこぼしの追加バックフィルは今後の更新で対応可

## 2026年7月（21件・5即以上 / 非掲載5件）
...
| 7 | @okarun_pua | おかるん@りお講習 | 14 | ストナン/ネトナン/箱 | [link](https://x.com/okarun_pua/status/2083390558547083356) |
| 8 | @tomu_riddle | とむりどる@マッチングアプリ世界一位🌍 | 14 | ネトナン | [link](https://x.com/tomu_riddle/status/2083477049273147574) |
| 9 | @nakayamasoku | 中山@tips更新中（ジジネト） | 13 | ネトナン | [link](https://x.com/nakayamasoku/status/2083363000371794046) |
| 10 | @yomaru_street | よまる@顔面淘汰男 | 13 | ストナン/箱 | [link](https://x.com/yomaru_street/status/2083310265932898545) |
| 11 | @bookmaker_2015 | とも | 12 | ストナン | [link](https://x.com/bookmaker_2015/status/2083185644617203933) |
| 12 | @anshin_pua | あんしん🎀ナンパ師 | 10 | ストナン/ネトナン | [link](https://x.com/anshin_pua/status/2083169564255481872) |
